...
@Component({
	selector: 'app-receipt-mobile',
	templateUrl: 'receipt-mobile.page.html',
	styleUrls: ['receipt-mobile.page.scss'],
	standalone: false,
})
export class ReceiptMobilePage extends PageBase {
	canAddNew = false;
	constructor(
							...
							if (POItem?.length > 0) {
								...
								this.alertCtrl
									.create({
										...
										//subHeader: '---',
										message: 'PO này chưa có ASN/receipt-mobile. Bạn có muốn tạo mới không?',
										buttons: [
											{
												text: 'Không',
												role: 'cancel',
