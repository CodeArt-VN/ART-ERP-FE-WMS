...
@Component({
  selector: 'app-item-detail-in-branch',
  templateUrl: 'item-detail-in-branch.page.html',
  styleUrls: ['item-detail-in-branch.page.scss'],
})
export class ItemDetailInBranchPage extends PageBase {
  branchList = [];
  selectedBranch = null;
  optionGroup = [
    {
