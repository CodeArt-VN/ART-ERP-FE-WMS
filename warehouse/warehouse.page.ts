...
export class WarehousePage extends PageBase {
    ...
    segmentView = '';
    optionGroup = [
        { Code: 'warehouse-input-output-inventory', Name: 'Nhập xuất tồn', Remark: '' },
        { Code: 'warehouse-transaction', Name: 'Nhật ký kho', Remark: '' },
        { Code: 'warehouse-item-lot', Name: 'Lot', Remark: '' },
        { Code: 'warehouse-item-location-lot-lpn', Name: 'Lot & LPN', Remark: '' },
